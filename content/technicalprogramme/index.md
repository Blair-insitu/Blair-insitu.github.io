...
sections:
  ...
  - block: markdown
    content:
      title: AUV2026 will feature two distinguished keynote speakers offering unique insights into the evolution of autonomous marine systems. 
      text: |
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start;">

          <!-- Column 1: Autosub Under Ice -->
          <div>
            <img src="/Gwyn Griffiths.jpg" style="width:100%; height:auto;">
          ...
          <!-- Column 2: Dan Hook -->
          <div>
            <img src="/Dan Hook.png" style="width:100%; height:auto;">
